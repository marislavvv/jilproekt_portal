// frontend/src/components/DepartmentChat.jsx
import React, { useState, useEffect, useRef, useCallback } from 'react';
import io from 'socket.io-client';
import axios from 'axios'; // Для получения данных пользователя

const SOCKET_SERVER_URL = 'http://localhost:5000'; // URL вашего бэкенда Socket.IO
